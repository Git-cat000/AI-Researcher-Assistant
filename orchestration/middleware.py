...
from ai_researcher_assistant.core.message import Message
...
class LoggingMiddleware(Middleware):
    ...
    async def before_act(self, state: ExecutionState, action: Dict[str, Any], context: Dict[str, Any]) -> None:
        logger.info(f"Step {state.current_step}: Executing skill '{action.get('skill')}' with params {action.get('parameters')}")
